...
Ca se lance simplement comme ça : sudo ./env-bullseye-arm64-Bibendum.sh
...
export DOCKER_IMAGE_NAME=raspbian-${DISTRIB}-${ARCH}-bibendum
export DOCKERFILE=Dockerfile-${DISTRIB}-${ARCH}-Bibendum
